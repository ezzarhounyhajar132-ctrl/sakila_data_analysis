...
All core tables (`actor`, `address`, `category`, `city`, `country`, `customer`, `film`, `film_actor`, `film_category`, `inventory`, `payment`, `rental`, `staff`, `store`) were fully cleaned and validated before analysis.
